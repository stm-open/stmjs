...
var Message = require('../src/js/stream/message').Message;
var Seed    = require('../src/js/stream/seed').Seed;
var Remote  = require('../src/js/stream/remote').Remote;
...
describe('Message', function(){
  ...
  describe('signHash', function(){
    ...
    it('should accept the hash as either a hex string or a bitArray', function(){
      ...
      var secret_string = 'sh5cscjV7LN7jzxHZXyQocRnwsFv5';
    ...
    it('should accept the secret as a string or scjl.ecc.ecdsa.secretKey object', function(){
      ...
      var secret_string = 'sh5cscjV7LN7jzxHZXyQocRnwsFv5';
      // var address = 'vJHTHQ4dNHPJ5FyDtarXjiqddLEGCzt84E';
      var hash = 'e865bcc63a86ef21585ac8340a7cc8590ed85175a2a718c6fb2bfb2715d13778';
    ...
    it('should throw an error if given an invalid secret key', function(){
      ...
      var secret_string = 'sbadsh5cscjV7LN7jzxHZXyQocRnwsFv5';
      var hash = 'e865bcc63a86ef21585ac8340a7cc8590ed85175a2a718c6fb2bfb2715d13778';
  ...
  describe('verifyHashSignature', function(){
    ...
    it('should throw an error if a callback function is not supplied', function(){
      ...
      var data = {
        ...
        account: 'vGKCBZT9idaGLFke9ytqpFvNw4eHU8dbLN'
      };
    ...
    it('should respond true if the signature is valid and corresponds to an active public key for the account', function(done){
      ...
      var data = {
        ...
        account: 'vGKCBZT9idaGLFke9ytqpFvNw4eHU8dbLN',
        signature: 'AAAAG3m+Zn753LusVaBilc6HCwcCm/zbLc4o2VnygVsW+BeYH5DqATOl22tHG+MBPeLcv+yWenIkNj2grUU66eqSaTU='
      };
      ...
      test_remote.request_account_info = function(account, callback) {
        if (account === data.account) {
          callback(null, {
            "account_data": {
              "Account": "vHq2wyUtLkAad3rURUk33q9gozd97skhSf",
              "Flags": 1114112,
              "LedgerEntryType": "AccountRoot",
              "RegularKey": "vGKCBZT9idaGLFke9ytqpFvNw4eHU8dbLN"
            }
          });
        } else {
        ...
        if (account === data.account) {
          callback(null, {
            "account_data": {
              ...
              "Flags": 1114112,
              "LedgerEntryType": "AccountRoot",
              "RegularKey": "vHq2wyUtLkAad3rURUk33q9gozd97skhSf"
            }
          });
        } else {
          callback(new Error('wrong account'));
