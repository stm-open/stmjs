...
var Transaction = require('../src/js/stream/transaction').Transaction;
...
function print_usage() {
  console.log(
    ...
    'Example: rsign.js sn2xgf3EsA7n9iNVVsvTmvpK7NKeE',
    JSON.stringify({
      TransactionType: 'Payment',
      Account: 'vUMjKdh4LvzsCmxNPPxq9fN8UFVDWxgmqJ',
      Destination: 'v48b8MTu8b9AfSZs3gtmMLyDaZ8vAaca9C',
      Amount: '200000000',
      Fee: '10',
      Sequence: 1
    })
