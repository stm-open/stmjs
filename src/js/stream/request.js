...
Request.prototype.buildPath = function(build) {
  ...
  if (build) {
    ...
    // ND: streamed currently intreprets the mere presence of `build_path` as the
    // value being `truthy`
...
Request.prototype.streamState = function(account, issuer, currency) {
  this.message.stream_state = {
    currency : currency,
    accounts : [
