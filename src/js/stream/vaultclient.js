...
function VaultClient(opts) {
  ...
  this.domain   = opts.domain || 'stream.com';
  this.infos    = { };
};
...
/**
 * Authenticate and retrieve a decrypted blob using a stream name and password
 *
 * @param {string}    username
...
VaultClient.prototype.updateAvatar  = blobClient.updateAvatar;
