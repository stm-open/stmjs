 ...
 *
 * @param {String|UInt160} account Stream Account
 * @return {UInt256}
 */
...
/**
 * Generate the key for a VStreamState entry.
 *
 * The ordering of the two account parameters does not matter.
 *
 * @param {String|UInt160} account1 First Stream Account
 * @param {String|UInt160} account2 Second Stream Account
 * @param {String|Currency} currency The currency code
 * @return {UInt256}
 */
Ledger.calcVStreamStateEntryHash =
Ledger.prototype.calcVStreamStateEntryHash = function (account1, account2, currency) {
  ...
  index.append([0, Ledger.space.streamState.charCodeAt(0)]);
...
*   issues with stream-lib's binary <--> json codecs.
*
*/
