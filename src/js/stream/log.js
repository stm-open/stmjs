/**
 * Logging functionality for stream-lib and any applications built on it.
 */
 ...
 * @example
 *
 *   var log = require('stream').log.sub('server');
 *
 ...
 *     stream.log.debug('My object is', myObj);
 */
module.exports = new Log();

/**
 * This is the logger for stream-lib internally.
 */
