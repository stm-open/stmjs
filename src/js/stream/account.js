...
/**
 * Retrieve this account's Stream trust lines.
 *
 * To keep up-to-date with changes to the AccountRoot entry, subscribe to the
 ...
 *
 *  @param {Hex-encoded String|StreamAddress} public_key
 *  @param {Function} callback
 *
 *  @callback
 *  @param {Error} err
...
/**
 *  Convert a hex-encoded public key to a Stream Address
 *
 *  @static
 *
 *  @param {Hex-encoded string|StreamAddress} public_key
 *  @returns {StreamAddress}
 */
Account._publicKeyToAddress = function(public_key) {
  // Based on functions in /src/js/stream/keypair.js
