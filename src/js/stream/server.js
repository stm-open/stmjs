 ...
 * `streamed` server. As such, this is a decent hook point to allow a WebSocket
 * interface conforming object to be used as a basis to mock streamed. This
 ...
 *
 * Incompatible with stream-lib client build
 */
...
/**
 * Disconnect from streamed WebSocket server
 *
 * @api public
 */
...
/**
 * Reconnect to streamed WebSocket server
 *
 * @api public
 */
...
/**
 * Connect to streamed WebSocket server and subscribe to events that are
...
/**
 * Retry connection to streamed server
 *
 * @api private
 */
...
/**
 * Handle incoming messages from streamed WebSocket server
 *
...
/**
 * Check that received message from streamed is valid
 *
 * @param {Object} message
 * @return {Boolean}
 */
...
/**
 * Send JSON message to streamed WebSocket server
 *
 ...
 * @return {Number} Final fee in STM for specified number of fee units
 * @api private
 */
