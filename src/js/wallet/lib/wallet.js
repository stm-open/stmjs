module.exports = function(options) {
  ...
  var StreamAddress = require(__dirname+'/stream_address.js')({ sjcl: options.sjcl });
  ...
  StreamWallet.prototype = {
    ...
    getPublicKeyHex: function(publicKey){
      var bits = sjcl.codec.bytes.toBits(publicKey.toBytesCompressed());
