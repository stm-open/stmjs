...
enum TER	// aka TransactionEngineResult
{
	...
	temBAD_SEND_STM_LIMIT,
	temBAD_SEND_STM_MAX,
	temBAD_SEND_STM_NO_DIRECT,
	temBAD_SEND_STM_PARTIAL,
	temBAD_SEND_STM_PATHS,
	temBAD_SIGNATURE,
	temBAD_SRC_ACCOUNT,
	temBAD_SEQUENCE,
	temDST_IS_SRC,
	...
	// 100 .. 129 C Claim fee only (stream transaction with no good paths, pay to non-existent account, no path)
	// Causes:
