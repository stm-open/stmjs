...
bool transResultInfo(TER terCode, std::string& strToken, std::string& strHuman)
{
	static struct {
		...
		{	tecNO_DST_INSUF_STM,	"tecNO_DST_INSUF_STM",		"Destination does not exist. Too little STM sent to create it."		},
		...
		{	temBAD_SEND_STM_LIMIT,		"temBAD_SEND_STM_LIMIT",		"Malformed: Limit quality is not allowed for STM to STM."		},
		{	temBAD_SEND_STM_MAX,		"temBAD_SEND_STM_MAX",			"Malformed: Send max is not allowed for STM to STM."			},
		{	temBAD_SEND_STM_NO_DIRECT,	"temBAD_SEND_STM_NO_DIRECT",	"Malformed: No Stream direct is not allowed for STM to STM."	},
		{	temBAD_SEND_STM_PARTIAL,	"temBAD_SEND_STM_PARTIAL",		"Malformed: Partial payment is not allowed for STM to STM."		},
		{	temBAD_SEND_STM_PATHS,		"temBAD_SEND_STM_PATHS",		"Malformed: Paths are not allowed for STM to STM."				},
		...
		{	temSTREAM_EMPTY,		"temSTREAM_EMPTY",			"PathSet with no paths."								},
